...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Haxeroids", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Haxeroids", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Haxeroids";
		app.meta["name"] = "Haxeroids";
		app.meta["packageName"] = "com.sample.haxeroids";
